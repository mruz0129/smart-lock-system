...
if ($result = $conn->query("SELECT * FROM staff ORDER BY staff_id "))
{
...
echo "<tr>
	<th class='theading'>Staff ID</th>
	<th class='theading'>Staff RFID</th>
	<th class='theading'>Staff Name</th>
	<th class='theading'>Staff Contact Number</th>
...
while ($row = $result->fetch_object())
{
	...
	echo "<tr>";
	echo "<td class='datainfo'>" . $row->staff_id . "</td>";
	echo "<td class='datainfo'>" . $row->staff_rfid . "</td>";
	echo "<td class='datainfo'>" . $row->staff_name . "</td>";
	echo "<td class='datainfo'>" . $row->staff_contact . "</td>";

	echo "<td class='datainfo'><a class='edit' href='SLSstaff_edit.php?id=" . $row->staff_id . "'>Edit</a></td>";
	echo "<td class='datainfo'><a class='edit' href='SLSstaff_delete.php?id=" . $row->staff_id . "'>Delete</a></td>";
	echo "</tr>";
}
