...
echo "<tr>
	<th class='theading'>Unit ID</th>
	<th class='theading'>Unit Name</th>
	<th class='theading'>Unit Day</th>
	<th class='theading'>Unit Start Date</th>
    <th class='theading'>Unit End Date</th>
    <th class='theading'>Unit Start Time</th>
    <th class='theading'>Unit End Time</th>
    <th class='theading'>Unit Details</th>
...
while ($row = $result->fetch_object())
{
	...
	echo "<tr>";
	echo "<td class='datainfo'>" . $row->unit_id . "</td>";
	echo "<td class='datainfo'>" . $row->unit_name . "</td>";
	echo "<td class='datainfo'>" . $row->unit_day . "</td>";
	echo "<td class='datainfo'>" . $row->unit_start_date . "</td>";
    echo "<td class='datainfo'>" . $row->unit_end_date . "</td>";
    echo "<td class='datainfo'>" . $row->start_time . "</td>";
    echo "<td class='datainfo'>" . $row->end_time . "</td>";
    
    echo "<td class='datainfo'><a class='edit'>Details</a></td>";
    echo "<td class='datainfo'><a class='edit' href='SLSunit_edit.php?id=" . $row->unit_id . "'>Edit</a></td>";
	echo "<td class='datainfo'><a class='edit' href='SLSunit_delete.php?id=" . $row->unit_id . "'>Delete</a></td>";
	echo "</tr>";
}
