...
include("connect.php");
$id = $_GET['id'];
$d = $conn->query("SELECT * FROM staff where staff_id='$id'");
   ...
   if(isset($_POST['submit']))
{
    ...
    $update=$conn->query("UPDATE staff SET staff_rfid='$staff_rfid',staff_id='$staff_id', staff_name='$staff_name', staff_contact='$staff_contact' WHERE staff_id='$id'");
              ...
              <table border="0" cellpadding="0" style="width:100%;">
                <tbody>
                    ...
                    <td  class="theading" width="960px" style="vertical-align: top">
                        ...
                        <tbody>
                            <tr>
                            <td colspan="2" style="color:#fff;padding-top: 50px;"><h1 style="text-align: center;font-size: 50px;">Edit Staff Information</h1>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <td class="registerinfo">Staff RFID:</td>
                                 <td style="padding-top:20px;"><input name="staff_rfid" type="text" style="width:300px;" value="<?php echo $check['staff_rfid'] ?>" required></td>
                            </tr>
                            <tr>
                                <td class="registerinfo">Staff ID:</td>
                                <td style="padding-top:20px;"><input name="staff_id" type="text" style="width:300px;" value="<?php echo $check['staff_id'] ?>" required></td>
                            </tr>
        
                             <tr>
                            <td class="registerinfo">Staff First Name:</td>
                                 <td style="padding-top:20px;"><input name="staff_name" type="text" style="width:300px;" value="<?php echo $check['staff_name'] ?>" required></td>
                            </tr>
                             <tr>
                            <td class="registerinfo">Staff Last Name:</td>
                                <td style="padding-top:20px;"><input name="staff_contact" type="text" style="width:300px;" value="<?php echo $check['staff_contact'] ?>" required></td>
                            </tr>
                                         <tr>
                            <td height="30px"></td>
                            </tr>
