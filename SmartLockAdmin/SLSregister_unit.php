   ...
   if(isset($_POST['submit']))
{
    ...
    $conn->query("INSERT INTO `unit` (`unit_id`, `unit_name`,`unit_day`,`unit_start_date`,`unit_end_date`, `start_time`, `end_time`) VALUES ('$unit_id', '$unit_name', '$unit_day', '$unit_start_date', '$unit_end_date', '$start_time','$end_time')");
   }
              ...
              <table border="0" cellpadding="0" style="width:100%;">
                <tbody>
                    ...
                    <td  class="theading" width="960px" style="vertical-align: top">
                        ...
                        <tbody>
                            <tr>
                            <td colspan="2" style="color:#fff;padding-top: 50px;"><h1 style="text-align: center;font-size: 50px;">Register Unit</h1>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <td class="registerinfo">Unit ID:</td>
                                 <td style="padding-top:20px;"><input name="unit_id" type="text" style="width:300px;" required></td>
                            </tr>
                            <tr>
                                <td class="registerinfo">Unit Name:</td>
                                <td style="padding-top:20px;"><input name="unit_name" type="text" style="width:300px;" required></td>
                            </tr>
        
                             <tr>
                            <td class="registerinfo">Unit Day:</td>
                                 <td style="padding-top:20px;"><input name="unit_day" type="text" style="width:300px;" required></td>
                                        </tr>
                            <tr>
                            <td class="registerinfo">Unit Start Date:</td>
                                <td style="padding-top:20px;"><input name="unit_start_date" type="date" style="width:300px;"></td>
                                        </tr>
                                         <tr>
                            <td class="registerinfo">Unit End Date:</td>
                                <td style="padding-top:20px;"><input name="unit_end_date" type="date" style="width:300px;"></td>
                                        </tr>
                                         <tr>
                            <td class="registerinfo">Unit Start Time:</td>
                                <td style="padding-top:20px;"><input name="start_time" type="time" style="width:300px;"></td>
                                        </tr>
                                         <tr>
                            <td class="registerinfo">Unit End Time:</td>
                                <td style="padding-top:20px;"><input name="end_time" type="time" style="width:300px;"></td>
                                        </tr>
                                         <tr>
                            <td height="30px"></td>
                            </tr>
