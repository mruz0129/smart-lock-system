   ...
   if(isset($_POST['submit']))
{
    ...
    $update=$conn->query("UPDATE student SET student_rfid='$student_rfid',student_id='$student_id', student_name='$student_name', student_type='$student_type', student_parents_contact='$student_parents_contact', home_address = '$home_address', school_name='$school_name' WHERE student_id='$id'");
              ...
              <table border="0" cellpadding="0" style="width:100%;">
                <tbody>
                    ...
                    <td  class="theading" width="960px" style="vertical-align: top">
                        ...
                        <tbody>
                            <tr>
                            <td colspan="2" style="color:#fff;padding-top: 50px;"><h1 style="text-align: center;font-size: 50px;">Edit Student Information</h1>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <td class="registerinfo">Student RFID:</td>
                                 <td style="padding-top:20px;"><input name="student_rfid" type="text" style="width:300px;" value="<?php echo $check['student_rfid'] ?>" required></td>
                            </tr>
                            <tr>
                                <td class="registerinfo">Student ID:</td>
                                <td style="padding-top:20px;"><input name="student_id" type="text" style="width:300px;" value="<?php echo $check['student_id'] ?>" required></td>
                            </tr>
        
                             <tr>
                            <td class="registerinfo">Student Name:</td>
                                 <td style="padding-top:20px;"><input name="student_name" type="text" style="width:300px;" value="<?php echo $check['student_name'] ?>" required></td>
                            </tr>
                            <tr>
                                            <td class="registerinfo">Student Type:</td>
                                            <td style="padding-top:20px;">
                                                <select name="student_type">
                                                    <option value="<?php echo $check['student_type']?>">Student</option>
                            ...
                            <td class="registerinfo">Student Parents Contact:</td>
                                <td style="padding-top:20px;"><input name="student_parents_contact" type="text" style="width:300px;" value="<?php echo $check['student_parents_contact'] ?>" ></td>
                                        </tr>
                                         <tr>
                            <td class="registerinfo">Home Address:</td>
                                <td style="padding-top:20px;"><input name="home_address" type="text" style="width:300px;" value="<?php echo $check['home_address'] ?>" ></td>
                                        </tr>
                                         <tr>
                            <td class="registerinfo">School Name:</td>
                                <td style="padding-top:20px;"><input name="school_name" type="text" style="width:300px;" value="<?php echo $check['school_name'] ?>" ></td>
                                        </tr>
                                         <tr>
                            <td height="30px"></td>
                            </tr>
