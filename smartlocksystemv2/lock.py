...
conn = pymysql.connect(host='169.254.166.6',user='admin',password='admin123',db='smartlockdb')
a = conn.cursor()
root = Tk()

global channel #GPIO pin number for relay switch
channel = 7
...
#Variables
global my_uid, guicunitcode, guicunit, guicstarttime, guicendtime, PhoneNumber
...
#SMS notification when child enter/left center
def twilio_send():
    account_sid = 'AC70f9f8411ad2e6dc4a9d58c747423bf9'
    auth_token = 'b7f6101a91de8eb3f1d3747c20dcb35f'
    
    PhoneNumber = '+60124305420'
    TwilioNumber = '+12023359136'
    
    #getphonenosql = ("select student_parents_contact from student where student_rfid=%s", newuid)
    #a.execute(getphonenosql)
    #PhoneNumber = a.fetchone()
    ...
    client.messages.create(
        to=PhoneNumber,
        from_=TwilioNumber,
        body='Your child has just entered the center, we will take it from here! Don\'t worry' + u'\U0001F600')
